...
func newUserAuth(db *gorm.DB, opts ...gen.DOOption) userAuth {
	...
	_userAuth.UserID = field.NewInt32(tableName, "user_id")
	_userAuth.LoginIP = field.NewBytes(tableName, "login_ip")
	_userAuth.LoginTime = field.NewString(tableName, "login_time")
...
func (u *userAuth) updateTableName(table string) *userAuth {
	...
	u.LoginTime = field.NewString(table, "login_time")
